...
CREATE TABLE detalle_pedido (
    ...
    CONSTRAINT FK_Id_Pedido_Pedidos
        FOREIGN KEY (id_pedido)
        REFERENCES pedidos (id_pedido),
    CONSTRAINT FK_Id_Plato_Platos
        FOREIGN KEY (id_plato)
        REFERENCES platos (id_plato)
);

ALTER TABLE clientes
ADD c_postal NUMERIC(5);
...
ALTER TABLE clientes
CHANGE c_postal codigo_postal NUMERIC(5);

ALTER TABLE platos
ADD CONSTRAINT CK_Precio_Plato
