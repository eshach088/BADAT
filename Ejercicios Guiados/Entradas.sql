...
CREATE TABLE espectaculos (
    ...
    CONSTRAINT FK_espectaculos_cod_recinto
...
CREATE TABLE representaciones (
    ...
    CONSTRAINT FK_representaciones_cod_espectaculo
...
CREATE TABLE precios_espectaculos (
    ...
    CONSTRAINT PK_precios_espectaculos
        PRIMARY KEY (cod_espectaculo, cod_recinto, zona),
    CONSTRAINT FK_precios_espectaculos_cod_espectaculo
        FOREIGN KEY (cod_espectaculo)
        REFERENCES espectaculos (cod_espectaculo),
    CONSTRAINT FK_precios_espectaculos_zonas_recintos
...
CREATE TABLE entradas (
    ...
    CONSTRAINT FK_entradas_espectadores
        FOREIGN KEY (dni_cliente)
        REFERENCES espectadores (dni_cliente),
    CONSTRAINT FK_entradas_representaciones
        FOREIGN KEY (cod_espectaculo, fecha, hora)
